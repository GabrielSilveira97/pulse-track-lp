...
const BannerSectionComponent = () => {
    return(
        <section className="flex flex-col md:flex-row gap-10 px-4 md:px-36 py-10 md:py-26 justify-between items-center">
            <div className="flex flex-col gap-5 text-center md:text-start">
                <h1 className="text-5xl font-semibold">Produtividade guiada por dados reais</h1>
                <h2>
